        ...
        <form class="formBase" action="" method="post" onsubmit="return validateForm()">
            ...
            <?php
                ...
                if (!empty($_POST)) {
                    ...
                    // Criando uma array indexado, ou seja, array que utiliza números nos seus índices, para puxar os dados do tipo de cadastro
                    $client = array(
                    ...
                    if ($conn) {
                        ...
                        try {
                            ...
                            $stmt = $conn->prepare("INSERT INTO cliente(nome, cpf, rg, cep, rua, numero_rua, bairro, cidade, uf, celular, email) VALUES(:nome, :cpf, :rg, :cep, :rua, :numero, :bairro, :cidade, :uf, :celular, :email)");
